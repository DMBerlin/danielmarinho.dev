  ...
  (): EventHandlerResponse<UserExperience[]> => {
    return [
      ...
      },
      {
        ...
        jobLocation: "Brazil",
        jobDescription: [
          "Tech Lead on the Integrations Team at Dominio fintech, providing banking solutions to accounting offices in Brazil.",
          "Led implementation of Open Finance system integrations to collect client banking data directly for accounting offices.",
          "Architected adapters to integrate Node.js microservices with legacy Java systems, enabling seamless data flow.",
          "Implemented comprehensive observability stack using Kibana, DataDog, and OpenTelemetry for tracing, monitoring, and logging.",
      ...
      },
      {
        ...
        jobLocation: "Brazil",
        jobDescription: [
          "Lead Software Developer on Platform Team for a Peruvian fintech serving over 13 million clients.",
          "Implementing solutions on Backstage platform (Spotify) to accelerate development cycles for growing engineering teams.",
